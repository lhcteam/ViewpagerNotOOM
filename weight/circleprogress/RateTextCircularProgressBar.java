package com.aosika.phonelive.player_lhc_costom.weight.circleprogress;
 ...
 * <p>实现了 进度条进度改变的监听 {@link CircularProgressBar.OnProgressChangeListener}，从而得到进度的百分比，然后显示到 TextView 上</p>
 * 
