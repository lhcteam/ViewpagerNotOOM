package com.aosika.phonelive.player_lhc_costom.weight;
...
/**
 * Created by lhc on 2016/2/29 0029.
 */
public class TimeView extends AppCompatTextView {
    ...
    private long days = 0;
    private long time = 0;
    private boolean isPause;//时间是否暂停
    ...
    public long  pause(){
        ...
        return getTimeForSecond();
    }

    /**
     * 时间继续
     */
    public void resume(long timePlay){
        diff=timePlay;
        getShowTime();
        //if(isPause){
            isPause=false;
